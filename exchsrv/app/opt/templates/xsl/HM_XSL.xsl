            ...
            <xsl:for-each select="ZL_LIST/ZAP">
                ...
                <xsl:for-each select="Z_SL">
                    ...
                    <xsl:for-each select="SL">
                        <div class="card" id="SL###{$idzap}" style="margin-top: 20px;">
                        <div class="card-body">
                        <h5 style="margin-bottom: 20px;">Секция SL</h5>
                            ...
                            <xsl:for-each select="DS2">
                                <xsl:variable name="ds2_id" select="position()" />
                                <div class="input-group mb-3">
                                    <span class="input-group-text">DS2</span>
                                    <input type="text" name="SL%%%{$idzap}###DS2---{$ds2_id}" class="form-control"><xsl:attribute name="value"><xsl:value-of select="self::node()" /></xsl:attribute></input>
                                </div>
                            </xsl:for-each>
                            <div class="input-group mb-3">
                            ...
                            <div class="input-group mb-3">
                                <span class="input-group-text">COMENTSL</span>
                                <input type="text" name="SL%%%{$idzap}###COMENTSL" class="form-control"><xsl:attribute name="value"><xsl:value-of select="COMENTSL" /></xsl:attribute></input>
                            </div>
                        <xsl:for-each select="KSG_KPG">
                            ...
                            <h5 style="margin-bottom: 20px;">Секция KSG_KPG</h5>
                                ...
                                <xsl:for-each select="SL_KOEF">
                                    <xsl:variable name="slkoef_id" select="position()" />
                                    <div class="card" style="margin-top: 20px;">
                                    <div class="card-body">
                                    <h5 style="margin-bottom: 20px;">Секция SL_KOEF</h5>
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">IDSL</span>
                                            <input type="text" name="SL_KOEF%%%{$idzap}+++{$slkoef_id}###IDSL" class="form-control"><xsl:attribute name="value"><xsl:value-of select="IDSL" /></xsl:attribute></input>
                                        </div>
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">Z_SL</span>
                                            <input type="text" name="SL_KOEF%%%{$idzap}+++{$slkoef_id}###Z_SL" class="form-control"><xsl:attribute name="value"><xsl:value-of select="Z_SL" /></xsl:attribute></input>
                                        </div>
                                    </div>
                                    </div>
                                </xsl:for-each>
                        ...
                        <xsl:for-each select="USL">
                            <xsl:variable name="usl_id" select="position()" />
                            <div class="card" style="margin-top: 20px;">
                            <div class="card-body">
                            <h5 style="margin-bottom: 20px;">Секция USL</h5>
                                <div class="input-group mb-3">
                                    <span class="input-group-text">IDSERV</span>
                                    <input type="text" name="USL%%%{$idzap}+++{$usl_id}###IDSERV" class="form-control"><xsl:attribute name="value"><xsl:value-of select="IDSERV" /></xsl:attribute></input>
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text">LPU</span>
                                    <input type="text" name="USL%%%{$idzap}+++{$usl_id}###LPU" class="form-control"><xsl:attribute name="value"><xsl:value-of select="LPU" /></xsl:attribute></input>
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text">LPU_1</span>
                                    <input type="text" name="USL%%%{$idzap}+++{$usl_id}###LPU_1" class="form-control"><xsl:attribute name="value"><xsl:value-of select="LPU_1" /></xsl:attribute></input>
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text">PODR</span>
                                    <input type="text" name="USL%%%{$idzap}+++{$usl_id}###PODR" class="form-control"><xsl:attribute name="value"><xsl:value-of select="PODR" /></xsl:attribute></input>
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text">PROFIL</span>
                                    <input type="text" name="USL%%%{$idzap}+++{$usl_id}###PROFIL" class="form-control"><xsl:attribute name="value"><xsl:value-of select="PROFIL" /></xsl:attribute></input>
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text">VID_VME</span>
                                    <input type="text" name="USL%%%{$idzap}+++{$usl_id}###VID_VME" class="form-control"><xsl:attribute name="value"><xsl:value-of select="VID_VME" /></xsl:attribute></input>
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text">DET</span>
                                    <input type="text" name="USL%%%{$idzap}+++{$usl_id}###DET" class="form-control"><xsl:attribute name="value"><xsl:value-of select="DET" /></xsl:attribute></input>
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text">DATE_IN</span>
                                    <input type="text" name="USL%%%{$idzap}+++{$usl_id}###DATE_IN" class="form-control"><xsl:attribute name="value"><xsl:value-of select="DATE_IN" /></xsl:attribute></input>
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text">DATE_OUT</span>
                                    <input type="text" name="USL%%%{$idzap}+++{$usl_id}###DATE_OUT" class="form-control"><xsl:attribute name="value"><xsl:value-of select="DATE_OUT" /></xsl:attribute></input>
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text">DS</span>
                                    <input type="text" name="USL%%%{$idzap}+++{$usl_id}###DS" class="form-control"><xsl:attribute name="value"><xsl:value-of select="DS" /></xsl:attribute></input>
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text">CODE_USL</span>
                                    <input type="text" name="USL%%%{$idzap}+++{$usl_id}###CODE_USL" class="form-control"><xsl:attribute name="value"><xsl:value-of select="CODE_USL" /></xsl:attribute></input>
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text">KOL_USL</span>
                                    <input type="text" name="USL%%%{$idzap}+++{$usl_id}###KOL_USL" class="form-control"><xsl:attribute name="value"><xsl:value-of select="KOL_USL" /></xsl:attribute></input>
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text">TARIF</span>
                                    <input type="text" name="USL%%%{$idzap}+++{$usl_id}###TARIF" class="form-control"><xsl:attribute name="value"><xsl:value-of select="TARIF" /></xsl:attribute></input>
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text">SUMV_USL</span>
                                    <input type="text" name="USL%%%{$idzap}+++{$usl_id}###SUMV_USL" class="form-control"><xsl:attribute name="value"><xsl:value-of select="SUMV_USL" /></xsl:attribute></input>
                                </div>
                                <xsl:for-each select="MR_USL_N">
                                    ...
                                    <h5 style="margin-bottom: 20px;">Секция MR_USL_N</h5>
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" name="MR_USL_N%%%{$idzap}+++{$usl_id}###MR_N" class="form-control"><xsl:attribute name="value"><xsl:value-of select="MR_N" /></xsl:attribute></input>
                                        </div>
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">PRVS</span>
                                            <input type="text" name="MR_USL_N%%%{$idzap}+++{$usl_id}###PRVS" class="form-control"><xsl:attribute name="value"><xsl:value-of select="PRVS" /></xsl:attribute></input>
                                        </div>
                                        <div class="input-group mb-3">
                                            <span class="input-group-text">CODE_MD</span>
                                            <input type="text" name="MR_USL_N%%%{$idzap}+++{$usl_id}###CODE_MD" class="form-control"><xsl:attribute name="value"><xsl:value-of select="CODE_MD" /></xsl:attribute></input>
                                        </div>
                                    </div>
                                    </div>
                                </xsl:for-each>
                        ...
                        <xsl:for-each select="LEK_PR">
                            <xsl:variable name="lekpr" select="position()" />
                            <div class="card" style="margin-top: 20px;">
                            <div class="card-body" id="LEK_PR%lek%{$idzap}$lek${$lekpr}">
                            <div class="row">
                                <div class="col">
                                    <h5 style="margin-bottom: 20px;">Секция LEK_PR</h5>
                                </div>
                                <div class="col">
                                    <a class="btn btn-outline-danger float-end" href="javascript:void(0);" onclick="del_lek_pr('LEK_PR%lek%{$idzap}$lek${$lekpr}')" role="button"> Удалить LEK_PR</a>
                                </div>
                            </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text">DATA_INJ</span>
                                    <input type="text" name="LEK_PR%%%{$idzap}$$${$lekpr}###DATA_INJ" class="form-control"><xsl:attribute name="value"><xsl:value-of select="DATA_INJ" /></xsl:attribute></input>
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text">CODE_SH</span>
                                    <input type="text" name="LEK_PR%%%{$idzap}$$${$lekpr}###CODE_SH" class="form-control"><xsl:attribute name="value"><xsl:value-of select="CODE_SH" /></xsl:attribute></input>
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text">REGNUM</span>
                                    <input type="text" name="LEK_PR%%%{$idzap}$$${$lekpr}###REGNUM" class="form-control"><xsl:attribute name="value"><xsl:value-of select="REGNUM" /></xsl:attribute></input>
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text">COD_MARK</span>
                                    <input type="text" name="LEK_PR%%%{$idzap}$$${$lekpr}###COD_MARK" class="form-control"><xsl:attribute name="value"><xsl:value-of select="COD_MARK" /></xsl:attribute></input>
                                </div>
                                <xsl:for-each select="LEK_DOSE">
                                    <xsl:variable name="lekdose" select="position()" />
                                    <div class="card" style="margin-top: 20px;">
                                    <div class="card-body" id="LEK_PR%dose%{$idzap}$dose${$lekpr}*dose*{$lekdose}">
                                        <div class="row">
                                            <div class="col">
                                                <h5 style="margin-bottom: 20px;">Секция LEK_DOSE</h5>
                                            </div>
                                            <div class="col">
                                                <a class="btn btn-outline-danger float-end" href="javascript:void(0);" onclick="del_lek_dose('LEK_PR%dose%{$idzap}$dose${$lekpr}*dose*{$lekdose}')" role="button"> Удалить LEK_DOSE</a>
                                            </div>
                                        </div>
                                              <div class="input-group mb-3">
                                                  <span class="input-group-text">ED_IZM</span>
                                                  <input type="text" name="LEK_DOSE%%%{$idzap}$$${$lekpr}***{$lekdose}###ED_IZM" class="form-control"><xsl:attribute name="value"><xsl:value-of select="ED_IZM" /></xsl:attribute></input>
                                              </div>
                                              <div class="input-group mb-3">
                                                  <span class="input-group-text">DOSE_INJ</span>
                                                  <input type="text" name="LEK_DOSE%%%{$idzap}$$${$lekpr}***{$lekdose}###DOSE_INJ" class="form-control"><xsl:attribute name="value"><xsl:value-of select="DOSE_INJ" /></xsl:attribute></input>
                                              </div>
                                              <div class="input-group mb-3">
                                                  <span class="input-group-text">METHOD_INJ</span>
                                                  <input type="text" name="LEK_DOSE%%%{$idzap}$$${$lekpr}***{$lekdose}###METHOD_INJ" class="form-control"><xsl:attribute name="value"><xsl:value-of select="METHOD_INJ" /></xsl:attribute></input>
                                              </div>
                                              <div class="input-group mb-3">
                                                  <span class="input-group-text">COL_INJ</span>
                                                  <input type="text" name="LEK_DOSE%%%{$idzap}$$${$lekpr}***{$lekdose}###COL_INJ" class="form-control"><xsl:attribute name="value"><xsl:value-of select="COL_INJ" /></xsl:attribute></input>
                                              </div>
                                    </div>
                                    </div>
                                </xsl:for-each>
                                <input type="hidden" id="LEK_DOSE%%{$idzap}$${$lekpr}" class="form-control" value="1"/>
                                <a class="btn btn-outline-success" href="javascript:void(0);" onclick="add_lek_dose('LEK_PR%%{$idzap}$${$lekpr}')" role="button" style="margin-top: 20px;"> Добавить LEK_DOSE</a>
                            </div>
                            </div>
                        </xsl:for-each>
                        <input type="hidden" id="LEK_PR##{$idzap}" class="form-control"><xsl:attribute name="value"><xsl:value-of select="1" /></xsl:attribute></input>
                        <a class="btn btn-outline-success" href="javascript:void(0);" onclick="add_lek_pr('LEK_PR##{$idzap}')" role="button" style="margin-top: 20px;"> Добавить LEK_PR</a>
                    </xsl:for-each>
                    </div>
                    </div>
                </xsl:for-each>
